    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_7399 = 0.0;
                float node_767_if_leA = step(i.posWorld.b,_zMin);
                float node_767_if_leB = step(_zMin,i.posWorld.b);
                float node_6956 = 0.0;
                float node_5489_if_leA = step(i.posWorld.b,_zMax);
                float node_5489_if_leB = step(_zMax,i.posWorld.b);
                float node_3469 = 0.0;
                clip((((lerp((node_4378_if_leA*node_9228)+(node_4378_if_leB*1.0),node_9228,node_4378_if_leA*node_4378_if_leB)*lerp((node_6592_if_leA*1.0)+(node_6592_if_leB*node_2217),node_2217,node_6592_if_leA*node_6592_if_leB))*(lerp((node_3956_if_leA*node_4401)+(node_3956_if_leB*1.0),node_4401,node_3956_if_leA*node_3956_if_leB)*lerp((node_3473_if_leA*1.0)+(node_3473_if_leB*node_7399),node_7399,node_3473_if_leA*node_3473_if_leB)))*(lerp((node_767_if_leA*node_6956)+(node_767_if_leB*1.0),node_6956,node_767_if_leA*node_767_if_leB)*lerp((node_5489_if_leA*1.0)+(node_5489_if_leB*node_3469),node_3469,node_5489_if_leA*node_5489_if_leB))) - 0.5);
